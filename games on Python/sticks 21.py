...
#
# Замечания
# Необходимо предусмотреть обработку неправильного ввода: человек может ввести как неправильное количество палочек (меньше 1 или больше 3), так и вообще не число. В такой ситуации нужно сообщить человеку, что он не прав, и повторить ввод. Ни в коем случае нельзя допускать, чтобы программа делала свой ход после неправильного ввода.
#
# Проиграть может как человек, так и программа. Очевидно, что программа проигрывает, если перед её ходом осталась ровно одна палочка. Человек проигрывает в аналогичной ситуации. Однако человек (да и программа тоже) проигрывает, если он взял все оставшиеся палочки. Например, осталось 2 палочки, и человек в свой ход вводит число 2. Это немедленный проигрыш. Необходимо предусмотреть и такую ситуацию.
#
# Программа (и человек) не должна в свой ход брать палочек больше, чем осталось на столе. Это касается ситуации, когда на столе осталось две палочки. Если программа решит при этом взять три, то на столе останется минус одна палочка?
#
# Существует беспроигрышный алгоритм игры, который обеспечивает победу второго игрока (то есть программы) в любой ситуации. Попробуйте разгадать его (необязательно).
#
# Пример работы
