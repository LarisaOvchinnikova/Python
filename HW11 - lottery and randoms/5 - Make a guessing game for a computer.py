# Пользователь загадывает число через инпут,
# а компьютер рандомно пытается угадать, с помощью тех же подсказок
# "Too big" или "Too small". Посчитайте количество попыток и время игры.
